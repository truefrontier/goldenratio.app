  ...
  <div class="Calculator">
    <div class="container">
        ...
        <div class="col w-gr-4">
          <div class="flex justify-between">
            ...
            <button
              @click="lCol = []"
              title="Clear All"
              class="btn flex-shrink-0 ml-3 text-pink-500 border-pink-500 text-lg"
            >
              &times;
            </button>
          </div>
      ...
      <div class="row items-top">
        <div ref="lCol" class="bg-stripes col w-gr-4 bg-white border-2 border-black">
          <div
        ...
        <div ref="rCol" class="bg-stripes col w-gr-4 bg-white border-2 border-black">
          <div
...
<style lang="scss">
.btn {
  @apply h-6 w-6 p-2 rounded-lg box-content leading-6 border text-center mr-3 mb-3;
  &:last-child {
    @apply mr-0;
  }
  &:hover {
